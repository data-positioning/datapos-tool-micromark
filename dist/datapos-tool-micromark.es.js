...
function ie(n, r) {
  let t;
  for (t in r) {
    const a = (On.call(n, t) ? n[t] : void 0) || (n[t] = {}), u = r[t];
    let i;
    if (u)
      for (i in u) {
        On.call(a, i) || (a[i] = []);
...
const Mn = pn(/\d/), he = pn(/[\dA-Fa-f]/), ce = pn(/[!-/:-@[-`{-~]/);
function P(n) {
  return n !== null && n < -2;
}
function H(n) {
...
const Xn = {}.hasOwnProperty, Jn = /^(https?|ircs?|mailto|xmpp)$/i, fe = /^https?$/i;
function pe(n) {
  const r = n || {};
  let t = !0;
  const e = {}, a = [[]], u = [], i = [], h = (
  ...
  function k(A) {
    ...
    for (h.enter.null && h.enter.null.call(p); ++_ < A.length; ) {
      const Qn = h[ln[_][0]], Gn = ln[_][1].type, Yn = Qn[Gn];
      Xn.call(Qn, Gn) && Yn && Yn.call({
...
`);
  ...
  function dn() {
    ...
    _.image ? (d('<img src="' + xn(en.destination, r.allowDangerousProtocol ? void 0 : fe) + '" alt="'), x(_.label), d('"')) : d('<a href="' + xn(en.destination, r.allowDangerousProtocol ? void 0 : Jn) + '"'), d(en.title ? ' title="' + en.title + '"' : ""), _.image ? d(" />") : (d(">"), x(_.label), d("</a>")), u.pop();
  }
  function _t() {
    T(), u.push({});
  }
  ...
  function Bt() {
    ...
    F(), Xn.call(e, _) || (e[_] = u[u.length - 1]), u.pop();
  }
  function Rt() {
  ...
  function te(A) {
    const _ = this.sliceSerialize(A), G = E("characterReferenceType") ? le(_, E("characterReferenceType") === "characterReferenceMarkerNumeric" ? 10 : 16) : ht(_);
    x(m(
      /** @type {string} */
      G
  ...
  function ee(A) {
    ...
    d('<a href="' + xn(_, r.allowDangerousProtocol ? void 0 : Jn) + '">'), x(m(_)), d("</a>");
  }
  function re(A) {
    const _ = this.sliceSerialize(A);
...
function ke(n) {
  ...
  function s(x) {
    ...
    return r.containerState = {}, n.check(Kn, p, o)(x);
  }
  function p(x) {
    return a && d(), F(e), k(x);
  }
  ...
  function k(x) {
    return r.containerState = {}, n.attempt(Kn, c, w)(x);
  }
  function c(x) {
...
function Te(n, r, t) {
  ...
  function s(o) {
    return o === 88 || o === 120 ? (n.enter("characterReferenceMarkerHexadecimal"), n.consume(o), n.exit("characterReferenceMarkerHexadecimal"), n.enter("characterReferenceValue"), u = 6, i = he, p) : (n.enter("characterReferenceValue"), u = 7, i = Mn, p(o));
  }
  function p(o) {
    if (o === 59 && a) {
      const k = n.exit("characterReferenceValue");
      return i === Z && !ht(e.sliceSerialize(k)) ? t(o) : (n.enter("characterReferenceMarker"), n.consume(o), n.exit("characterReferenceMarker"), n.exit("characterReference"), r);
    }
...
function De(n, r, t) {
  ...
  function o(m) {
    return m === null || P(m) ? (n.exit("codeFencedFence"), e.interrupt ? r(m) : n.check(tt, E, S)(m)) : (n.enter("codeFencedFenceInfo"), n.enter("chunkString", {
      contentType: "string"
    }), k(m));
  }
  function k(m) {
  ...
  function d(m) {
    return m === null || P(m) ? n.check(tt, E, S)(m) : (n.enter("codeFlowValue"), x(m));
  }
  function x(m) {
...
function Ye(n, r, t) {
  ...
  function a(l) {
    return wt(n, u, t, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(l);
  }
  function u(l) {
...
const tr = [
  ...
  "track",
  "ul"
], rt = ["pre", "script", "style", "textarea"], er = {
  concrete: !0,
  name: "htmlFlow",
  resolveTo: ur,
  tokenize: ar
...
function ar(n, r, t) {
  ...
  function T(f) {
    if (f === null || f === 47 || f === 62 || H(f)) {
      ...
      return !W && !u && rt.includes(nn) ? (a = 1, e.interrupt ? r(f) : D(f)) : tr.includes(i.toLowerCase()) ? (a = 6, W ? (n.consume(f), F) : e.interrupt ? r(f) : D(f)) : (a = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(f) : u ? d(f) : x(f));
    }
  ...
  function N(f) {
    if (f === 62) {
      ...
      return rt.includes(W) ? (n.consume(f), Q) : D(f);
    }
...
function dr(n, r, t) {
  ...
  function u(o) {
    return o === 41 ? p(o) : kt(n, i, l, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(o);
  }
  function i(o) {
  ...
  function h(o) {
    return o === 34 || o === 39 || o === 40 ? wt(n, s, t, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(o) : p(o);
  }
  function s(o) {
...
function kr(n, r, t) {
  ...
  return a;
  function a(l) {
    return bt.call(e, n, u, i, "reference", "referenceMarker", "referenceString")(l);
  }
  function u(l) {
...
function zr(n, r, t) {
  ...
  function l(c) {
    ...
    if (w === "listUnordered" ? !e.containerState.marker || c === e.containerState.marker : Mn(c)) {
  ...
  function h(c) {
    return Mn(c) && ++i < 10 ? (n.consume(c), h) : (!e.interrupt || i < 2) && (e.containerState.marker ? c === e.containerState.marker : c === 41 || c === 46) ? (n.exit("listItemValue"), s(c)) : t(c);
  }
  function s(c) {
...
const Br = {
  resolveAll: St()
}, Rr = yt("string"), Nr = yt("text");
function yt(n) {
  return {
    resolveAll: St(n === "text" ? Hr : void 0),
    tokenize: r
  };
  function r(t) {
...
function ei() {
  ...
  function a(u, i, l) {
    ...
    for (u = r + (typeof u == "string" ? u.toString() : new TextDecoder(i || void 0).decode(u)), o = 0, r = "", t && (u.charCodeAt(0) === 65279 && o++, t = void 0); o < u.length; ) {
      if (ut.lastIndex = o, s = ut.exec(u), k = s && s.index !== void 0 ? s.index : u.length, c = u.charCodeAt(k), !s) {
        r = u.slice(o);
        break;
      }
      if (c === 10 && o === k && e)
...
function li(n, r, t) {
  ...
  return i;
  function i(o) {
    return !Rn(o) || !Dt.call(e, e.previous) || $n(e.events) ? t(o) : (n.enter("literalAutolink"), n.enter("literalAutolinkEmail"), l(o));
  }
  function l(o) {
    return Rn(o) ? (n.consume(o), l) : o === 64 ? (n.consume(o), h) : t(o);
  }
  function h(o) {
...
function oi(n, r, t) {
  ...
  return a;
  function a(i) {
    return i !== 87 && i !== 119 || !zt.call(e, e.previous) || $n(e.events) ? t(i) : (n.enter("literalAutolink"), n.enter("literalAutolinkWww"), n.check(ii, n.attempt(Ft, n.attempt(Ct, u), t), t)(i));
  }
  function u(i) {
...
function si(n, r, t) {
  ...
  return i;
  function i(o) {
    return (o === 72 || o === 104) && Tt.call(e, e.previous) && !$n(e.events) ? (n.enter("literalAutolink"), n.enter("literalAutolinkHttp"), a += String.fromCodePoint(o), n.consume(o), l) : t(o);
  }
  function l(o) {
    if (X(o) && a.length < 5)
  ...
  function s(o) {
    return o === null || En(o) || H(o) || bn(o) || Nn(o) ? t(o) : n.attempt(Ft, n.attempt(Ct, p), t)(o);
  }
  function p(o) {
...
function ci(n, r, t) {
  ...
  return i;
  function i(s) {
    return s === 46 || s === 95 ? n.check(At, h, l)(s) : s === null || H(s) || bn(s) || s !== 45 && Nn(s) ? h(s) : (u = !0, n.consume(s), i);
  }
  function l(s) {
...
function gi(n, r) {
  ...
  return a;
  function a(i) {
    return i === 40 ? (t++, n.consume(i), a) : i === 41 && e < t ? u(i) : i === 33 || i === 34 || i === 38 || i === 39 || i === 41 || i === 42 || i === 44 || i === 46 || i === 58 || i === 59 || i === 60 || i === 63 || i === 93 || i === 95 || i === 126 ? n.check(At, r, u)(i) : i === null || H(i) || bn(i) ? r(i) : (n.consume(i), a);
  }
  function u(i) {
...
function $i(n, r) {
  ...
  for (; ++t < n.length; ) {
    const c = n[t], w = c[1];
    c[0] === "enter" ? w.type === "tableHead" ? (l = !1, h !== 0 && (at(k, r, h, s, p), p = void 0, h = 0), s = {
      type: "table",
  ...
  for (h !== 0 && at(k, r, h, s, p), k.consume(r.events), t = -1; ++t < r.events.length; ) {
    const c = r.events[t];
...
const Lt = /<(\/?)(iframe|noembed|noframes|plaintext|script|style|title|textarea|xmp)(?=[\t\n\f\r />])/gi, qi = new RegExp("^" + Lt.source, "i");
function ji() {
  return {
    exit: {
      htmlFlowData(n) {
...
function Ji() {
  return st || (st = 1, (function(n) {
    ...
    n.exports && (n.exports = t), typeof ot < "u" && (ot.Prism = t), t.languages.markup = {
      comment: {
        pattern: /<!--(?:(?!<!--)[\s\S])*?-->/,
        greedy: !0
      },
...
`), a = t.lang || "plain", u = t.meta || "";
          let i = "";
          if (a === "json" && u === "datapos-visual")
            i = `<div class="${u}" data-options="${encodeURIComponent(e)}"></div>`;
          else if (a === "json" && u === "datapos-highcharts")
            i = `<div class="${u}" data-options="${encodeURIComponent(e)}"></div>`;
          else if (vn?.languages[a]) {
            const l = vn.highlight(e, vn.languages[a], a);
